---
title: "Cape Cod"
description: "Desde los faros icónicos que custodian el vasto Atlántico hasta la danza serena de las ballenas en el horizonte, descubre el encanto conmovedor de Cape…"
layout: "gallery"
...
{{< gallery >}}
    ...
    <img src="/gallery/cape_cod/cape_cod_013.webp" 
         ...
         loading="lazy" decoding="async" 
         data-lqip="true" 
         style="background-image: url(/gallery/cape_cod/lqip/cape_cod_013.jpg); background-size: cover;" 
         onload="this.classList.add('loaded')" />
{{< /gallery >}}