---
title: "Chicago"
description: "Descubre la arquitectura monumental y el ambiente único de Chicago. Desde los reflejos plateados del Cloud Gate en el Millennium Park hasta los…"
layout: "gallery"
...
itinerary_days:
  - label: "Sábado"
    items:
      ...
      - "Magnificent Mile"
      - "The Loop"
      - "Recorrido a pie por los puentes"
      - "Riverwalk"
      - "Millennium Park"
      - "The Bean (Cloud Gate)"
      - "Bub City"
      - "Crucero de arquitectura (First Lady Cruises)"
      - "Giordano's (pizza deep-dish)"
  - label: "Domingo"
    items:
      - "Goddess and the Baker (desayuno)"
      - "Zoológico de Lincoln Park"
      - "Lincoln Park Conservatory"
      - "Noria de Navy Pier"
      - "Offshore Rooftop"
      - "Barrio Damen & Wicker (Wicker Park)"
      - "Big Star (tacos)"
      - "Green Mill Jazz Club"
  - label: "Lunes"
    items:
      - "Bakery Au Levain (desayuno)"
