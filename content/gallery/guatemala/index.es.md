---
title: "Guatemala"
description: "Desde las calles empedradas de Antigua y las antiguas pirámides mayas hasta los picos ardientes de Fuego y Acatenango, embárcate en un viaje visual a…"
layout: "gallery"
...
itinerary_days:
  - label: "30 de agosto — Ciudad de Guatemala"
    ...
    items:
      - "Ciudad de Guatemala"
      - "Mercado Central"
  - label: "31 de agosto — Antigua"
    coords: [14.5586, -90.7295]
    items:
      - "Autobús hacia Antigua"
      - "Antigua"
      - "Starbucks Antigua"
      - "McDo Antigua"
      - "Mercado de artesanías El Carmen"
      - "Cerro de la Cruz"
  - label: "1 de septiembre — Antigua"
    items:
      - "Madre Tierra (parrillada chapina)"
      - "Antigua Brewing Company"
      - "Hobbitenango"
  - label: "2 de septiembre — Acatenango"
    coords: [14.5008, -90.8757]
    items:
      - "Autobús hacia Acatenango"
      - "Ascenso al Acatenango"
      - "Caminata hacia el Fuego"
  - label: "3 de septiembre — Acatenango"
    items:
      - "Ascenso a la cima del Acatenango"
  - label: "4 de septiembre — Panajachel"
    coords: [14.7407, -91.1583]
    items:
      - "Autobús hacia Panajachel"
      - "Panajachel"
      - "Chichicastenango"
      - "Hotel Santo Tomás"
      - "Lago de Atitlán"
  - label: "5 de septiembre — Lago de Atitlán"
    coords: [14.6910, -91.2699]
    items:
      - "Autobús hacia San Pedro La Laguna"
      - "San Pedro La Laguna"
      - "Sababa Restaurant"
      - "San Juan La Laguna"
      - "San Marcos La Laguna"
  - label: "6 de septiembre — San Pedro La Laguna"
    items:
      - "Relax y playa en San Pedro"
  - label: "7 de septiembre — Regreso a Ciudad de Guatemala"
    coords: [14.6349, -90.5069]
    items:
      - "Autobús de regreso a Ciudad de Guatemala"
  - label: "8 de septiembre — Flores"
    coords: [16.9276, -89.8934]
    items:
      - "Vuelo hacia Flores"
      - "Relax y playa en Flores"
  - label: "9 de septiembre — Tikal"
    coords: [17.2220, -89.6237]
    items:
      - "Excursión a Tikal"
  - label: "10 de septiembre — Flores"
    items:
      - "Regreso a Flores"
      - "Maracuyás (Flores)"
  - label: "11 de septiembre — Flores"
    items:
      - "Hostel Oasis"
  - label: "12 de septiembre — Semuc Champey"
    coords: [15.5347, -90.3396]
    items:
      - "Vuelo de regreso Flores → Ciudad de Guatemala"
      - "Autobús hacia Semuc Champey"
      - "Semuc Champey"
  - label: "13 de septiembre — Regreso a Ciudad de Guatemala"
    items:
      - "Autobús de regreso a Ciudad de Guatemala"
---

<div class="gallery-description max-w-2xl mx-auto mb-8 text-neutral-600 dark:text-neutral-400 tracking-wide">
&nbsp;&nbsp;&nbsp;&nbsp;Desde las calles empedradas de Antigua y las antiguas pirámides mayas hasta los picos ardientes de Fuego y Acatenango, embárcate en un viaje visual a través del alma atemporal de Guatemala, donde la historia colonial se encuentra con el poder puro de la tierra.
</div>
...
{{< gallery >}}
  ...
  <video autoplay loop muted playsinline preload="metadata" class="video-element"><source src="https://pub-4f55cfaeea7f4e58ae5f19966ae63baf.r2.dev/2025-09-11%2019-05-15.mov" type="video/mp4"></video>
    <img src="/gallery/guatemala/guatemala_001.webp" 
         alt="Capturando la esencia única de Guatemala. Foto de Romain Charretteur." 
    ...
    <img src="/gallery/guatemala/guatemala_002.webp" 
         alt="La atmósfera única de Guatemala, una toma con reflejos fríos." 
         title="" 
    ...
    <img src="/gallery/guatemala/guatemala_003.webp" 
         alt="Exploración visual de Guatemala, con una estética única." 
    ...
    <img src="/gallery/guatemala/guatemala_006.webp" 
         alt="Una vista única de Guatemala. con tonos cálidos" 
    ...
    <img src="/gallery/guatemala/guatemala_009.webp" 
         alt="La atmósfera única de Guatemala, una toma con tonos cálidos." 
    ...
    <img src="/gallery/guatemala/guatemala_013.webp" 
         alt="La atmósfera única de Guatemala, una toma exuberante." 
    ...
    <img src="/gallery/guatemala/guatemala_016.webp" 
         alt="Una vista única de Guatemala. oscura y misteriosa" 
    ...
    <img src="/gallery/guatemala/guatemala_017.webp" 
         alt="Una vista única de Guatemala. exuberante" 
    ...
    <img src="/gallery/guatemala/guatemala_019.webp" 
         alt="Una vista única de Guatemala. con reflejos fríos" 
