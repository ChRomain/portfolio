---
title: "Guatemala"
description: "Des rues pavées d'Antigua et des anciennes pyramides mayas aux sommets enflammés du Fuego et de l'Acatenango, embarquez pour un voyage visuel à travers…"
layout: "gallery"
...
country_code: "gt"
itinerary_days:
  - label: "30 août — Guatemala City"
    coords: [14.6349, -90.5069]
    items:
      - "Guatemala City"
      - "Mercado Central"
  - label: "31 août — Antigua"
    ...
    items:
      ...
      - "Cerro de la Cruz"
  - label: "1er septembre — Antigua"
    items:
      - "Madre Tierra (parrillada chapina)"
      - "Antigua Brewing Company"
      - "Hobbitenango"
  - label: "2 septembre — Acatenango"
    coords: [14.5008, -90.8757]
    items:
      - "Bus vers Acatenango"
      - "Ascension de l'Acatenango"
      - "Randonnée vers le Fuego"
  - label: "3 septembre — Acatenango"
    items:
      - "Ascension au sommet de l'Acatenango"
  - label: "4 septembre — Panajachel"
    ...
    items:
      ...
      - "Hôtel Santo Tomás"
      - "Lago de Atitlán"
  - label: "5 septembre — Lac Atitlán"
    coords: [14.6910, -91.2699]
    items:
      - "Bus vers San Pedro La Laguna"
      - "San Pedro La Laguna"
      - "Sababa Restaurant"
      - "San Juan La Laguna"
      - "San Marcos La Laguna"
  - label: "6 septembre — San Pedro La Laguna"
    items:
      - "Détente et plage à San Pedro"
  - label: "7 septembre — Retour à Guatemala City"
    coords: [14.6349, -90.5069]
    items:
      - "Bus retour vers Guatemala City"
  - label: "8 septembre — Flores"
    coords: [16.9276, -89.8934]
    items:
      - "Vol vers Flores"
      - "Détente et plage à Flores"
  - label: "9 septembre — Tikal"
    coords: [17.2220, -89.6237]
    items:
      - "Excursion à Tikal"
  - label: "10 septembre — Flores"
    items:
      - "Retour à Flores"
      - "Maracuyás (Flores)"
  - label: "11 septembre — Flores"
    items:
      - "Hostel Oasis"
  - label: "12 septembre — Semuc Champey"
    coords: [15.5347, -90.3396]
    items:
      - "Vol retour Flores → Guatemala City"
      - "Bus vers Semuc Champey"
      - "Semuc Champey"
  - label: "13 septembre — Retour à Guatemala City"
    items:
      - "Bus retour vers Guatemala City"
---

<div class="gallery-description max-w-2xl mx-auto mb-8 text-neutral-600 dark:text-neutral-400 tracking-wide">
&nbsp;&nbsp;&nbsp;&nbsp;Des rues pavées d'Antigua et des anciennes pyramides mayas aux sommets enflammés du Fuego et de l'Acatenango, embarquez pour un voyage visuel à travers l'âme intemporelle du Guatemala—où l'histoire coloniale rencontre la puissance brute de la terre.
</div>
...
{{< gallery >}}
  ...
  <video autoplay loop muted playsinline preload="metadata" class="video-element"><source src="https://pub-4f55cfaeea7f4e58ae5f19966ae63baf.r2.dev/2025-09-11%2019-05-15.mov" type="video/mp4"></video>
    <img src="/gallery/guatemala/guatemala_001.webp" 
         alt="Exploration visuelle de Guatemala, révélant une esthétique unique." 
    ...
    <img src="/gallery/guatemala/guatemala_002.webp" 
         alt="Cliché unique immortalisé à Guatemala par Romain Charretteur." 
         title="" 
    ...
    <img src="/gallery/guatemala/guatemala_007.webp" 
         alt="Une vue unique de Guatemala. aux tons chauds" 
    ...
    <img src="/gallery/guatemala/guatemala_009.webp" 
         alt="Atmosphère unique à Guatemala, une photographie aux tons chauds." 
    ...
    <img src="/gallery/guatemala/guatemala_013.webp" 
         alt="Atmosphère unique à Guatemala, une photographie luxuriante." 
    ...
    <img src="/gallery/guatemala/guatemala_016.webp" 
         alt="Atmosphère unique à Guatemala, une photographie sombre et mystérieuse." 
    ...
    <img src="/gallery/guatemala/guatemala_017.webp" 
         alt="Une vue unique de Guatemala. luxuriante" 
    ...
    <img src="/gallery/guatemala/guatemala_018.webp" 
         alt="Atmosphère unique à Guatemala, une photographie aux reflets froids." 
    ...
    <img src="/gallery/guatemala/guatemala_021.webp" 
         alt="Une vue unique de Guatemala. aux reflets froids" 
