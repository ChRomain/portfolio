---
title: "Niagara Falls"
description: "Párate en el borde del mundo donde las aguas atronadoras se encuentran con un horizonte iluminado por neón. Presencia la fuerza abrumadora de las…"
layout: "gallery"
images: ["/gallery/niagara_falls/feature.webp"]
dominant_color: "#4e7ba8"
tags: ["urbain", "neige", "lac_riviere", "faune", "nuit"]
country_code: "ca"
---
...
{{< gallery >}}
  ...
  <video autoplay loop muted playsinline preload="metadata" class="video-element"><source src="https://pub-4f55cfaeea7f4e58ae5f19966ae63baf.r2.dev/2025-08-24%2013-22-45.mp4" type="video/mp4"></video>
    <img src="/gallery/niagara_falls/niagara_falls_001.webp" 
         alt="Exploración visual de Niagara Falls, con una estética única." 
    ...
    <img src="/gallery/niagara_falls/niagara_falls_002.webp" 
         alt="Una vista única de Niagara Falls. con reflejos fríos" 
         title="Canon EOS Rebel T100 | f/11.0 | 1/500s | ISO 100" 
          
         data-color="#558ab6" 
         data-tone="bleu" 
         data-tags="lac_riviere,neige" 
         width="1600" height="2400" 
         loading="lazy" decoding="async" 
         data-lqip="true" 
    ...
    <img src="/gallery/niagara_falls/niagara_falls_003.webp" 
         alt="La atmósfera única de Niagara Falls, una toma con reflejos fríos." 
    ...
    <img src="/gallery/niagara_falls/niagara_falls_004.webp" 
         alt="Capturando la esencia única de Niagara Falls. Foto de Romain Charretteur." 
    ...
    <img src="/gallery/niagara_falls/niagara_falls_006.webp" 
         alt="Una vista única de Niagara Falls. con tonos cálidos" 
         title="iPhone 15 | f/1.6 | 1/15s | ISO 500" 
          
         data-color="#865e4f" 
         data-tone="rouge" 
         data-tags="nuit,lac_riviere" 
    ...
    <img src="/gallery/niagara_falls/niagara_falls_011.webp" 
         alt="Una vista única de Niagara Falls. luminosa" 
    ...
    <img src="/gallery/niagara_falls/niagara_falls_013.webp" 
         alt="Una vista única de Niagara Falls. exuberante" 
    ...
    <img src="/gallery/niagara_falls/niagara_falls_014.webp" 
         alt="La atmósfera única de Niagara Falls, una toma con tonos cálidos." 
